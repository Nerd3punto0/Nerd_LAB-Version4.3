...
public class CreditosCtFragment extends Fragment {
    ...
    //private String jugadores [] = {"No hay jugador","No hay jugador","No hay jugador","No hay jugador","No hay jugador"};
    //private String puntajecon [] = {"0","0","0","0","0"};
    String jugadores [] = new String[5];
    String puntajecon[] = new String[5];
    private TextView tjugador1, tjugador2, tjugador3, tjugador4, tjugador5;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        puntajecon=bundle.getStringArray("puntajecon");}
